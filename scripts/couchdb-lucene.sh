...
if [ -a /usr/local/couchdb-lucene/bin/run ]; then
	...
	curl -fSLs https://github.com/BuddhistDigitalResourceCenter/couchdb-lucene/releases/download/v2.2.0pre/couchdb-lucene-2.2.0-SNAPSHOT-dist.tar.gz -o couchdb-lucene.tar.gz
